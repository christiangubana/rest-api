...
const Weather = () => {
  ...
  return (
    <div className="max-w-md mx-auto rounded overflow-hidden shadow-lg w-full md:w-1/2 py-10 px-5 md:px-10 bg-red-400">
    ...
    <div className="px-6 py-4 bg-slate-600">
        <div className="flex justify-between items-center">
          <input
            ...
            rounded py-2 px-4 block w-full appearance-none leading-normal"
          />
          <button
